...
auto GetDataset()
{
    ...
    auto spatial_dim_elements = generate_data(std::vector<std::vector<std::size_t>>{{28, 28}});
    auto filter_dims = generate_data(std::vector<std::vector<std::size_t>>{{1, 1}, {3, 3}, {5, 5}});
