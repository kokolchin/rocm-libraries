...
protected:
                                                  ...
                                                  bool withConstraint = false)
    {
        ...
        auto defaultVal = hipdnn_data_sdk::data_objects::CreateIntValue(builder, defaultValue);
...
{
    const KnobWrapper wrapper(static_cast<hipdnn_data_sdk::data_objects::Knob*>(nullptr));
